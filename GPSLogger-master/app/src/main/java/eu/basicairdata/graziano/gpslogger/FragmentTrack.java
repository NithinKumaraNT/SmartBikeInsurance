...
public class FragmentTrack extends Fragment {
    ...
    public void Update() {
        ...
        Log.w("Hackathon","Time :"+Float.toString(track.getDuration()/1000));
        Log.w("Hackathon","Distance :" + Float.toString(track.getEstimatedDistance()));
        Log.w("Hackathon","Speed :" + Float.toString(track.getSpeedAverage()));

        if (track.getDuration()/1000 >= GPSActivity.Control() * 20)
        {
